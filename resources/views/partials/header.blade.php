    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center"
        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand" href="{{ route('indexUser') }}"><span class="brand-logo">
                            <div class="logo-img"><img class="logo-img" alt="Apex logo"
                                    src="{{ asset('app-assets2/img/logo-dark.png') }}"></div>
                        </span>
                        <h2 class="brand-text mb-0">اقرأ</h2>
                    </a></li>
            </ul>
        </div>
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"
                                id="usernameProfile"> </span><span
                                class="user-status">{{ Session::get('fname') . ' ' . Session::get('lname') }}</span>
                        </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a
                            class="dropdown-item" href="{{ route('profile') }}"><i class="mr-50"
                                data-feather="user"></i>
                            الملف الشخصي</a>
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"><i class="mr-50"
                                data-feather="power"></i> تسجيل الخروج</a>
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="dropdown nav-item active"><a class=" nav-link d-flex align-items-center"
                            href="{{ route('indexUser') }}"><i data-feather="home"></i><span
                                data-i18n="Dashboards">الرئيسية</span></a>

                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            class="dropdown-toggle nav-link d-flex align-items-center" href="#"
                            data-toggle="dropdown"><i data-feather="package"></i><span data-i18n="Apps">ادارة
                                الطلبات</span></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('userOrdersDone', Session::get('userid')) }}"
                                    data-toggle="dropdown" data-i18n="Email"><i data-feather="mail"></i><span
                                        data-i18n="Email">عرض
                                        الطلبات</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('userOrdersNote', Session::get('userid')) }}"
                                    data-toggle="dropdown" data-i18n="Chat"><i
                                        data-feather="message-square"></i><span data-i18n="Chat">الطلبات الغير مكتملة
                                    </span></a>
                            </li>
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            ...
                            data-toggle="dropdown"><i data-feather="edit"></i><span
                                data-i18n="Forms &amp; Tables">الكتب</span></a>
                        <ul class="dropdown-menu">

                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('allBooks') }}" data-toggle="dropdown" data-i18n="Form Layout"><i
                                        data-feather="box"></i><span data-i18n="Form Layout">عرض الكتب
                                    </span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('searchBookPage') }}" data-toggle="dropdown"
                                    data-i18n="Form Wizard"><i data-feather="package"></i><span
                                        data-i18n="Form Wizard">البحث عن كتاب
                                    </span></a>
                            </li>
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            class="dropdown-toggle nav-link d-flex align-items-center" href="#"
                            data-toggle="dropdown"><i data-feather="settings"></i><span data-i18n="Pages">المؤلفون و
                                دور النشر</span></a>
                        <ul class="dropdown-menu">

                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('authorBooks') }}" data-toggle="dropdown" data-i18n="Profile"><i
                                        data-feather="user"></i><span data-i18n="Profile">
                                        المؤلفون</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('publisherBooks') }}" data-toggle="dropdown" data-i18n="FAQ"><i
                                        data-feather="help-circle"></i><span data-i18n="FAQ">دور النشر</span></a>
                            </li>
